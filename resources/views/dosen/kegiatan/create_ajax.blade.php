<form action="{{ route('dosen.storeAjax') }}" method="POST" id="form-tambah">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input value="" type="text" name="tempat_kegiatan" id="tempat_acara" class="form-control" required>
    ...
    $(document).ready(function() {
        ...
        $("#form-tambah").validate({
            rules: {
                ...
                tempat_kegiatan: { required: true, minlength: 3, maxlength: 255 },

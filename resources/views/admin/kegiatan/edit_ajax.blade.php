                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jabatan_id[]" class="form-control jabatan-select" required>
                                        ...
                                        @foreach($jabatan as $j)
                                            <option value="{{ $j->id_jabatan_kegiatan }}" {{ $anggota->id_jabatan_kegiatan == $j->id_jabatan_kegiatan ? 'selected' : '' }}>{{ $j->jabatan_nama }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="anggota_id[]" class="form-control anggota-select" required>
                                        ...
                                        @foreach($anggota as $a)
                                            <option value="{{ $a->id_user }}" {{ $anggota->id_user == $a->id_user ? 'selected' : '' }}>{{ $a->nama }}</option>
                                        @endforeach
                                    </select>

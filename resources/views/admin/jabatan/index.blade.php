...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            <button onclick="modalAction('{{ url('/admin/jabatan/create_ajax') }}')" class="btn btn-sm btn-success mt-1" data-toggle="modal" data-target="#modal-master">Tambah Ajax</button>
        </div>
    </div>
    <div class="card-body">
        @if (session('success'))
    ...
    $(document).ready(function() {
        var dataJabatan = $('#jabatan-kegiatan-table').DataTable({
            ...
            columns: [
                ...
                { data: 'jabatan_nama', name: 'jabatan_nama', className: "text-center" },

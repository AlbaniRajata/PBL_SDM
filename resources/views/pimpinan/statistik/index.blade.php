...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="{{ url('/pimpinan/statistik/export_excel') }}" class="btn btn-sm btn-outline-success btn-hover">
                <i class="fa-solid fa-file-excel"></i> Export Excel
            </a>
            <a href="{{ url('/pimpinan/statistik/export_pdf') }}" class="btn btn-sm btn-outline-warning btn-hover">
...
<script>
    $(document).ready(function() {
        ...
        var statistikTable = $('#statistik-dosen-table').DataTable({
            ...
            responsive: true,
            ajax: {
                url: "{{ route('pimpinan.statistik.list') }}",
                type: "POST",
                data: function(d) {
    ...
    $.ajax({
        url: "{{ route('pimpinan.statistik.details') }}",
        method: 'POST',

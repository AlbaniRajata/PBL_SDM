...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="{{ url('/pimpinan/statistik/export_excel') }}" class="btn btn-sm btn-success mt-1">
                <i class="fa-solid fa-file-excel"></i> Ekspor Excel
            </a>
            <a href="{{ url('/pimpinan/statistik/export_pdf') }}" class="btn btn-sm btn-warning mt-1">
